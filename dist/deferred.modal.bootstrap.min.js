 ...
 */
!function(E,D){"use strict";var e=E.jQuery,_={rejectOnDismiss:!0,returnDeferred:!0},a={DATA_ATTR_PROMISE_DISPATCH:"data-promise-dispatch",DATA_KEY_PROMISE_DISPATCH:"promiseDispatch",DATA_KEY_DEFERRED:"modalDeferred",DATA_KEY_RETURN_DEFERRED:"returnDeferred",DATA_KEY_REJECT_ON_DISMISS:"rejectOnDismiss",VALUE_PENDING_DEFERRED_STATE:"pending"},A=function(E){var D=e.Deferred();D.always(function(){E.modal("hide")}),E.data(a.DATA_KEY_DEFERRED,D)};e.fn.modalDeferred=function(E){var t,r,R=this;return"string"==typeof E?"deferred"===E?t=R.data(a.DATA_KEY_DEFERRED):R.modal(E):(r=e.extend({},_,E||{}),R.each(function(){var E=e(this);A(E),E.data(a.DATA_KEY_RETURN_DEFERRED,r.returnDeferred).data(a.DATA_KEY_REJECT_ON_DISMISS,r.rejectOnDismiss).on("show.bs.modal",function(){var D=E.data(a.DATA_KEY_DEFERRED);D&&D.state()===a.VALUE_PENDING_DEFERRED_STATE||A(E)}).on("hide.bs.modal",function(){var D=E.data(a.DATA_KEY_DEFERRED);D.state()===a.VALUE_PENDING_DEFERRED_STATE&&D[E.data(a.DATA_KEY_REJECT_ON_DISMISS)?"reject":"resolve"]()}).on("click","["+a.DATA_ATTR_PROMISE_DISPATCH+"]",function(){var D="resolve"===e(this).data(a.DATA_KEY_PROMISE_DISPATCH);E.data(a.DATA_KEY_DEFERRED)[D?"resolve":"reject"](),E.modal("hide")}).modal(r)})),t===D&&(t=1===R.length&&R.data(a.DATA_KEY_RETURN_DEFERRED)?R.data(a.DATA_KEY_DEFERRED):R),t}}(this);